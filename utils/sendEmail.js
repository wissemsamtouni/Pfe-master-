...
const sendEmail = async (user, subject, text) => {
 ...
 border-top: 10px solid #ffa117;
 border-right: 18px solid #ffa117;
 border-bottom: 10px solid #ffa117;
 border-left: 18px solid #ffa117;
 }
 ...
 <span style="color: darkgreen;">NEW</span>PASS
 </a>
 </td>
 </tr>
 <!-- Email Body -->
 ...
 <h1>salut ${user.nom} ${user.prenom} ,</h1>
 ...
 <tr>
 <td align="center">
 <a href="${text}"  class="f-fallback button button--orange" target="_blank">Reinitialiser votre mot de passe</a>
 </td>
 </tr>
 </table>
 </td>
